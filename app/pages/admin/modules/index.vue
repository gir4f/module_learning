<template>
  <section v-auto-animate="{ duration: 180, easing: 'ease-out' }" class="mx-auto w-full max-w-7xl space-y-6 px-3 pb-12 sm:px-0">
    <section v-auto-animate="{ duration: 180, easing: 'ease-out' }" class="relative mb-8 overflow-hidden rounded-3xl bg-slate-900 p-6 text-white shadow-lg sm:p-10 sm:shadow-2xl">
      ...
      <div class="relative grid gap-8 lg:grid-cols-[1fr_340px] lg:items-center">
        ...
        <dl v-auto-animate="{ duration: 180, easing: 'ease-out' }" class="grid grid-cols-1 overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-1 shadow-lg shadow-slate-950/10 min-[360px]:grid-cols-3 sm:backdrop-blur-md">
